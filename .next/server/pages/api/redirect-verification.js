"use strict";(()=>{var e={};e.id=982,e.ids=[982],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},4014:e=>{e.exports=import("iron-session")},6326:e=>{e.exports=import("resend")},6090:e=>{e.exports=import("stripe")},8:(e,t,o)=>{o.a(e,async(e,r)=>{try{o.r(t),o.d(t,{config:()=>p,default:()=>d,routeModule:()=>c});var i=o(1802),a=o(7153),s=o(6249),n=o(3155),l=e([n]);n=(l.then?(await l)():l)[0];let d=(0,s.l)(n,"default"),p=(0,s.l)(n,"config"),c=new i.PagesAPIRouteModule({definition:{kind:a.x.PAGES_API,page:"/api/redirect-verification",pathname:"/api/redirect-verification",bundlePath:"",filename:""},userland:n});r()}catch(e){r(e)}})},3155:(e,t,o)=>{o.a(e,async(e,r)=>{try{o.r(t),o.d(t,{default:()=>handler});var i=o(6090),a=o(6326),s=o(6713),n=e([i,a,s]);[i,a,s]=n.then?(await n)():n;let l=new i.default(process.env.STRIPE_SECRET_KEY),d=new a.Resend(process.env.RESEND_API_KEY);async function handler(e,t){try{let{session_id:o,product_name:r}=e.query;if(!o)return t.status(400).send("Missing session_id");if(!r)return t.status(400).send("Missing product_name");let i=await l.checkout.sessions.retrieve(o),a=await l.identity.verificationSessions.create({type:"document",metadata:{email:i.customer_email||i.customer_details?.email,product:r},return_url:"https://stripe-vercel-function.vercel.app/verification-complete"}),n={verificationSessionId:a.id,product:r,email:i.customer_email||i.customer_details?.email,createdAt:Date.now()},p=await (0,s.e)(n);t.setHeader("Set-Cookie",`verification_session=${p}; Path=/; HttpOnly; Secure; SameSite=Lax`),i.customer_details?.email&&await d.emails.send({from:"Get Tax Relief Now <donotreply@updates.gettaxreliefnow.com>",to:i.customer_details.email,subject:`Your Purchase Confirmation: ${r}`,html:`
  <html>
